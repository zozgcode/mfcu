        ...
        <div className="bg-white rounded-lg p-4">
          {user?.transaction_history.map((transaction: Transaction) => (
            <div key={transaction.transaction_id} className="flex justify-between py-3">
              ...
              <button className="border-none flex items-center justify-center outline-none rounded-full w-[35px] h-[35px] bg-[#007AC0]/10"><HiArrowDown className={`${transaction.amount_usd < 0 ? "rotate-180" : ""}`} /></button>
